...
// Rows (0-19) correspond to character positions in the spell, wrapped by PasswordMatrixRows.
// Columns (0-9) correspond to letter groups: column 0 for non-letters,
// columns 1-9 for letter groups A-C through Y-Z (CharactersPerMatrixCell letters per group, last group may be shorter).
